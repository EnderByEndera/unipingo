...
type PersonalInfo struct {
	...
	Situation string `bson:"situation" json:"situation"` // 具体情况
}
...
type QuestionBoxQuestion struct {
	...
	School      EntityWithName     `bson:"schoolID" json:"schoolID"`     // 所提问学校的ID
	Major       EntityWithName     `bson:"majorID" json:"majorID"`       // 所提问专业的ID
...
type QuestionLabel struct {
	...
	CreateTime uint64                `bson:"createTime" json:"createTime"`
	UpdateTime uint64                `bson:"updateTime" json:"updateTime"`
	Statistics LabelStats            `bson:"labelInfo" json:"labelInfo"` // 问题标签相关的数据
