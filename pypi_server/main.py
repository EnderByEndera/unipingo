import sys
sys.argv.extend(['run', './packages', '--fallback-url', 'https://pypi.tuna.tsinghua.edu.cn/simple'])
#! /usr/bin/env python3
...
from pypiserver.bottle import request
...
def main(argv: t.Sequence[str] = None) -> None:
    ...
    # def before_req():
    #     if request.urlparts
    #     print(request.urlparts, bottle.response.status )
    #     print('before-req!')

    # app.add_hook('after_request', before_req)
